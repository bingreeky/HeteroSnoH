...
class GATConv(MessagePassing):
    ...
    def forward(self, x: Union[Tensor, OptPairTensor], edge_index: Adj,
                ...
                return_attention_weights=None, edge_mask = None):
        # type: (Union[Tensor, OptPairTensor], Tensor, OptTensor, Size, NoneType, NoneType) -> Tensor  # noqa
