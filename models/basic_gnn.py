    ...
    def forward(  # noqa
        ...
        for i, (conv, norm) in enumerate(zip(self.convs, self.norms)):
            ...
            if self.supports_edge_weight and self.supports_edge_attr:
                ...
                x = conv(x, edge_index, edge_weight=edge_weight, edge_mask=edge_mask)
            elif self.supports_edge_attr:
                x = conv(x, edge_index, edge_attr=edge_attr, edge_mask=edge_mask)
            else:
                x = conv(x, edge_index, edge_mask=edge_mask)
